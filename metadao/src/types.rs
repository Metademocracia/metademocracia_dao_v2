...
/// That being said,  used "" (empty String) as a convention to represent the $NEAR token.
...
///  had to adapt since "" was not allowed anymore and we chose to represent the token as a
