...
use near_sdk::{
    ...
    PanicOnDefault, Promise, PromiseResult, serde_json::json,
};

pub use crate::bounties::{Bounty, BountyClaim, VersionedBounty};
pub use crate::policy::{
    default_policy, Policy, RoleKind, RolePermission, VersionedPolicy, VotePolicy, RolePermissionJson,
};
...
pub struct Contract {
    ...
    pub wallet_fee: AccountId,

    pub fee_metadao: U128,
}
...
impl Contract {
    ...
    pub fn set_fee_metadao(&mut self, fee_metadao: U128) -> U128 {
        assert!(self.wallet_fee.clone() == env::predecessor_account_id(), "only metadao");
